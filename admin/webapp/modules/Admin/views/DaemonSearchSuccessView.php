<?php
/**
* DaemonSearchSuccessView goes to a page allowing you to view an account
...
class DaemonSearchSuccessView extends AdminIndexView {
	...
	public function execute ()
	{
		...
		// set our template
		$this->setTemplate("DaemonSearchSuccess.php");
